...
execute_process(
  COMMAND "/opt/local/bin/git" show-ref 3.2.10
  WORKING_DIRECTORY "/Users/Roll/desktop/GeodesyPlus/lib/libigl/cmake/../external/eigen"
...
# yet).
execute_process(
  COMMAND "/opt/local/bin/git" rev-list --max-count=1 3.2.10
  WORKING_DIRECTORY "/Users/Roll/desktop/GeodesyPlus/lib/libigl/cmake/../external/eigen"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/Roll/desktop/GeodesyPlus/lib/libigl/cmake/../external/eigen/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/Roll/desktop/GeodesyPlus/lib/libigl/cmake/../external/eigen/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/opt/local/bin/git" checkout 3.2.10
      WORKING_DIRECTORY "/Users/Roll/desktop/GeodesyPlus/lib/libigl/cmake/../external/eigen"
      RESULT_VARIABLE error_code
      )
    if(error_code)
